...
`geom_textgrid` and `geom_labelgrid` perform the same arrangement operation for text labels as `geom_pointgrid` for points. `geom_segmentgrid` draws segments between the original point positions and the grid positions. This enables a mechanism for label placement, both for arbitrary scatter plots, and for maps.
