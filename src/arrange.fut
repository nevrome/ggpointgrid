...
-- sort indices by distance key (ascending)
def sortIndicesf16 [n] (xs: [n]f16): [n]i64 =
  zip xs (iota n)
  |> radix_sort_float_by_key (.0) f16.num_bits f16.get_bit
  |> map (.1)
